...
<p align="center">
  기존 영상 플랫폼은 음성을 자막으로 보조하는 데 머물러<br/>
  효과음, 배경음, 감정 변화처럼 몰입에 중요한 소리 정보가 쉽게 누락됩니다.
</p>

<br/>

<p align="center">
  SoundView는 AI로 영상의 음성·감정·배경음을 분석하고<br/>
  <b>자막과 햅틱 피드백으로 소리를 읽고 느끼는 시청 경험</b>을 제공하고자 기획했습니다.
</p>
...
- 전체 프로젝트 기간 : 2026.02.24 ~ 2026.04.11 (약 7주)
- 플랫폼 : Web, IoT Device
- 개발 인원 : 6명
